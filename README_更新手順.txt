...
<head>
  ...
  <meta name="description" content="BASE CAMP YAMATO｜鷺沼駅徒歩15分。渋谷から田園都市線で1本・23分。仕事・トレーニング・遊びを自由に楽しめる完全貸切の秘密基地。">
...
<main id="top">
  <section class="hero">
    <img src="assets/hero-main.webp" alt="BASE CAMP YAMATOの空間イメージ">
  </section>
  ...
  <section id="equipment" class="section soft reveal">
    ...
    <div class="equipment-grid">
      ...
      <article>
        <svg class="equipment-art" viewBox="0 0 360 220" role="img" aria-label="筋トレマシンと各種トレーニング小道具">
          <g fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <h3>トレーニング</h3>
        <p>筋トレマシンに加え、ダンベルやケトルベル、ヨガマットなど、トレーニングに適した小道具を常備しています。</p>
      </article>
  ...
  <section id="rank" class="section reveal">
    <p class="section-label">階級制度</p>
    <h2>秘密基地で過ごすほど、あなたの称号が増えていく。</h2>
    <p class="lead">累計利用回数に応じて、ひでまるおばけと一緒に階級が上がります。特典内容は運用状況に合わせて少しずつ育てていく予定です。</p>
    <button class="visual-card zoomable" type="button" data-image="assets/rank-system.webp" aria-label="階級制度を拡大表示">
      <img src="assets/rank-system.webp" alt="YAMATOBASE階級制度">
      <span>クリックして大きく見る</span>
    </button>
  </section>

  <section id="guide" class="section soft reveal">
    <p class="section-label">利用案内</p>
    <h2>基地を気持ちよく使うためのガイド。</h2>
    <div class="material-grid">
      <article>
        <button class="visual-card zoomable" type="button" data-image="assets/rules-guide.webp" aria-label="基本的な注意事項を拡大表示">
          <img src="assets/rules-guide.webp" alt="BASE CAMP YAMATOの基本的な注意事項">
          <span>基本ルールを見る</span>
        </button>
      </article>
      <article>
        <button class="visual-card zoomable" type="button" data-image="assets/hidemaru-guide.webp" aria-label="ひでまるおばけの紹介を拡大表示">
          <img src="assets/hidemaru-guide.webp" alt="ひでまるおばけの紹介と仕事">
          <span>ひでまるおばけを知る</span>
        </button>
      </article>
    </div>
  </section>
  ...
  <section id="story" class="section reveal">
    ...
    <h2 class="story-title">一人ではできないことを、仲間と楽しめる場所へ。</h2>
    <div class="story-copy handwritten-copy">
  ...
  <section id="access" class="section soft reveal">
    ...
    <div class="access-card">
      <div>
        ...
        <p>〒216-0005<br>神奈川県川崎市宮前区土橋4丁目3−28</p>
        <p>渋谷から田園都市線で1本・23分</p>
      </div>
      <a class="outline-button" href="https://www.google.com/maps/search/?api=1&query=神奈川県川崎市宮前区土橋4丁目3-28" target="_blank" rel="noopener">Googleマップで見る</a>
    </div>
  </section>
